  ...
  const faqs = [
    {
      ...
      a: (
        <div className="font-body text-base text-[#3a4740] space-y-4">
          ...
          <div className="border-l-2 border-[#0b4f35] pl-4 space-y-3">
            <div>
              <strong className="text-[#013220] block text-sm uppercase font-extrabold tracking-wide">Weeks 0–2: Bacterial Clearout</strong>
              <p className="text-sm">Mouth bacteria decreases. Bad breath begins to fade, yielding noticeably fresher kisses.</p>
            </div>
            <div>
              <strong className="text-[#013220] block text-sm uppercase font-extrabold tracking-wide">Weeks 2–4: Gum Relief</strong>
              <p className="text-sm">Sensitive gum borders soothe. Inflammation and redness start to decline.</p>
            </div>
            <div>
              <strong className="text-[#013220] block text-sm uppercase font-extrabold tracking-wide">Weeks 4–6+: Plaque Slowdown</strong>
              <p className="text-sm">Structural plaque consolidation slows. Tartar buildup is visibly reduced, resulting in cleaner teeth.</p>
            </div>
          </div>
        </div>
      ),
    },
    {
      ...
      a: (
        <div className="font-body text-base text-[#3a4740]">
          <p className="mb-2">Yes, they absolutely will! <strong>Kukku Pets Natural is 100% tasteless, odorless, and colorless</strong>.</p>
          <p className="text-sm">Unlike chemical mouthwashes, our formula does not alter the taste, smell, or texture of your dog's drinking water. Even the pickiest dogs who reject standard dental products drink their water normally and reap all the benefits.</p>
        </div>
      ),
    },
    {
      ...
      a: (
        <div className="font-body text-base text-[#3a4740] space-y-3">
    ...
    },
    {
      ...
      a: (
        <div className="font-body text-base text-[#3a4740]">
          ...
          <p className="text-sm">Unlike human toothpastes or cheap pet mouthwashes, we contain <strong>zero alcohol, zero parabens, and absolutely zero xylitol</strong> (which is toxic to dogs). We use only non-toxic, pet-safe Ayurvedic botanicals and organic minerals.</p>
        </div>
      ),
    },
    {
      ...
      a: (
        <div className="font-body text-base text-[#3a4740] space-y-2">
