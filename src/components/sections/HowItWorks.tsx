      ...
      <div className="container">
        ...
        <div className="how-steps">
          ...
          <div className="step-card">
            ...
            <p>Your dog drinks normally. The tasteless, odorless formula is completely unnoticeable to them.</p>
          </div>
          <div className="step-card">
            <div className="step-num">4</div>
            <h3>See the Results</h3>
            <p>Within 2 weeks, notice fresher breath. By 4–6 weeks, cleaner teeth and healthier gums.</p>
          </div>
        </div>
      </div>
    </section>
